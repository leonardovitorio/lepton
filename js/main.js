...
import { PodcastsServices } from "./services/PodcastsService.js";

new App(sources, ()=>{
    //Declare dependencies
    services.Users = new UsersService()
    services.Podcasts = new PodcastsServices()
    ...
    services.Menu = new WebService("/lepton/api/menu.json")
